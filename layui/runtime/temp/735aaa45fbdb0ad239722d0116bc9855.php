<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\base_info\feedback.html";i:1577773132;s:82:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\common\head.html";i:1577767329;s:84:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\common\footer.html";i:1576813615;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div style="overflow-x: hidden;width: 96%;margin: auto;padding-top: 1rem;" class="cbp-spmenu-push">
    <blockquote class="layui-elem-quote layui-text">
        <div class="demoTable layui-form">
            <div class="layui-input-inline">
                <input type="text" name="title" class="layui-input" placeholder=" 搜索关键字">
            </div>
    ...
    <table class="layui-table" lay-data="{height: '', url:'<?php echo (isset($url) && ($url !== '')?$url:''); ?>', page:true, id:'testReload',even: true,loading:true}" lay-filter="demo">
        <thead>
        <tr>
            <th lay-data="{field:'user_name',width:100,align:'center'}">名称</th>
            <th lay-data="{field:'mobile',width:120,align:'center'}">联系电话</th>
            <th lay-data="{field:'email',width:120,align:'center'}">邮箱</th>
            <th lay-data="{field:'title',align:'center'}">标题</th>
            <th lay-data="{field:'content',align:'center'}">描述</th>
            <th lay-data="{field:'admin_note',event: 'setSign',align:'center'}">后台备注</th>
                ...
                switch(event){
                    ...
                    case 'setSign':
                        layer.prompt({
                            ...
                            layer.close(index);
                            $.post('<?php echo url("BaseInfo/apiSaveFeedback"); ?>',{feedback_id:data.feedback_id,admin_note:value},function (res) {
                                layer.msg(res.msg);
                            },'JSON')
