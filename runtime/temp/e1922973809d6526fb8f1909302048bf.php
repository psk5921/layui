<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\Log\logTravelDate.html";i:1577773071;s:82:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\common\head.html";i:1577767329;s:84:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\common\footer.html";i:1576813615;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div style="overflow-x: hidden;width: 96%;margin: auto;padding-top: 1rem;">
    ...
    <div class="demoTable">
        <table class="layui-table" lay-data="{height: '', url:'<?php echo url('Log/apiGetTravelDateLog'); ?>', page:true, id:'testReload',even: true,loading:true}" lay-filter="demo">
            <thead>
            <tr>
                <th lay-data="{field:'route_name',align:'center'}">路线名称</th>
                <th lay-data="{field:'ranks_name',align:'center'}">出队名称</th>
                <th lay-data="{field:'travel_date',align:'center'}">出团排期</th>
            ...
            table.on('tool(demo)', function(obj){
                ...
                if(obj.event === 'sel'){
                    layer.open({
                        ...
                        maxmin: true, //开启最大化最小化按钮
                        area: ['100%', '100%'],
                        content: '<?php echo url("Log/logTravelDateDetails"); ?>?log_id='+data.log_id,
                        end: function () {
                            table.reload('testReload');
                        },
                    });
