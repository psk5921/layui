<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\Log\log_list.html";i:1577773172;s:82:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\common\head.html";i:1577767329;s:84:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\common\footer.html";i:1576813615;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div style="overflow-x: hidden;width: 96%;margin: auto;padding-top: 1rem;">
    <blockquote class="layui-elem-quote layui-text">
        <div class="demoTable layui-form">
            <div class="layui-input-inline">
                <input type="text" class="layui-input RangeDate" placeholder=" 年月日-年月日 ">
            </div>
            <div class="layui-input-inline" style="width: 30%">
                <input type="text" name="username" placeholder="搜索订单号|队员名称|手机号|身份证" class="layui-input">
            </div>
    ...
    <div class="demoTable">
        <table class="layui-table" lay-data="{height: '', url:'<?php echo url('Admin/ApiGetAdminList'); ?>', page:true, id:'testReload',even: true,loading:true}" lay-filter="demo">
            <thead>
            <tr>
                <th lay-data="{field:'role_name',width:100,align:'center'}">ID</th>
                <th lay-data="{field:'hread_img',width:100,align:'center',templet: '#hread_img'}">操作类型</th>
                <th lay-data="{field:'admin_name',width:100,align:'center'}">管理员名称</th>
                <th lay-data="{field:'admin_number',align:'center'}">操作描述</th>
                <th lay-data="{field:'login_number',align:'center'}">模块</th>
                <th lay-data="{field:'mobile',align:'center'}">方法</th>
                <th lay-data="{field:'position',align:'center'}">操作时间</th>
                <th lay-data="{field:'status', templet: '#status',align:'center'}">状态</th>
                <th lay-data="{ width:140, align:'center', toolbar: '#barDemo'}"></th>
            </thead>
        </table>
        ...
        <script type="text/html" id="hread_img">
            <a href="{{ d.hread_img }}" target= _blank><img src="{{ d.hread_img }}" style="height: 20px;"  lay-event="detail_content"></a>
        </script>
        ...
        layui.use(['table','laydate'], function(){
            ...
            table.on('tool(demo)', function(obj){
                ...
                if(obj.event === 'edit'){
                    layer.open({
                        ...
                        maxmin: true, //开启最大化最小化按钮
                        area: ['100%', '100%'],
                        content: '<?php echo url("Admin/saveAdminInfo"); ?>?admin_id='+data.admin_id,
                        end: function () {
                            table.reload('testReload');
                        },
                    });
                    ...
                    layer.open({
                        ...
                        maxmin: true, //开启最大化最小化按钮
                        area: ['100%', '100%'],
                        content: '<?php echo url("Admin/saveAdminPayKey"); ?>?admin_id='+data.admin_id,
                        end: function () {
                            table.reload('testReload');
                        },
                    });
            ...
            $('.addInfo').on('click', function() {
                layer.open({
                    ...
                    maxmin: true, //开启最大化最小化按钮
                    area: ['100%', '100%'],
                    content: '<?php echo url("Admin/saveAdminInfo"); ?>',
                    end: function () {
                        table.reload('testReload');
                    },
                });
