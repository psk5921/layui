<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:92:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\User\user_server_save.html";i:1576813616;s:82:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\common\head.html";i:1577767329;s:84:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\common\footer.html";i:1576813615;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div style="height:40rem;overflow-x: hidden;width: 98%;margin: auto;padding-top: 1rem;" class="cbp-spmenu-push">

    <div class="layui-form-pane layui-form layui-form-pane">

        <input type="hidden" name="id" value="<?php echo (isset($info['id']) && ($info['id'] !== '')?$info['id']:''); ?>">
        <input type="hidden" name="user_id" value="<?php echo (isset($user_info['user_id']) && ($user_info['user_id'] !== '')?$user_info['user_id']:''); ?>">
        <input type="hidden" name="route_id" value="<?php echo (isset($route_info['route_id']) && ($route_info['route_id'] !== '')?$route_info['route_id']:''); ?>">
        <input type="hidden" name="travel_date_id" value="<?php echo (isset($travel_date_info['travel_date_id']) && ($travel_date_info['travel_date_id'] !== '')?$travel_date_info['travel_date_id']:''); ?>">

        <div class="layui-form-item">
            <label class="layui-form-label">会员名称</label>
            <div class="layui-input-inline">
                <input type="text" value="<?php echo (isset($user_info['real_name']) && ($user_info['real_name'] !== '')?$user_info['real_name']:''); ?>"  class="layui-input" disabled>
            </div>
            <label class="layui-form-label">联系方式</label>
            <div class="layui-input-inline">
                <input type="text" value="<?php echo (isset($user_info['mobile']) && ($user_info['mobile'] !== '')?$user_info['mobile']:''); ?>"  class="layui-input" disabled>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">出行排期</label>
            <div class="layui-input-block">
                <input type="text" value="<?php echo (isset($travel_date_info['travel_date_info']) && ($travel_date_info['travel_date_info'] !== '')?$travel_date_info['travel_date_info']:''); ?>"  class="layui-input" disabled>
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">维护记录</label>
            <div class="layui-input-block">
                <textarea name="note" placeholder="请输入内容" lay-verify="required" class="layui-textarea"><?php echo (isset($info['note']) && ($info['note'] !== '')?$info['note']:''); ?></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
...
<script>
    ...
    layui.use(['form','element','rate','table'], function() {
        ...
        form.on('submit(submit)', function(data){
            $.post('<?php echo url("User/ApiSaveUserServer"); ?>',data.field,function (res) {
