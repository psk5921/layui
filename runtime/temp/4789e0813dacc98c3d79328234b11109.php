<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\base_info\file_add.html";i:1576813614;s:82:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\common\head.html";i:1576813615;s:84:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\common\footer.html";i:1576813615;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div style="overflow-x: hidden;width: 96%;margin: auto;padding-top: 1rem;">
    ...
    <div class="layui-form layui-form-pane">
        ...
        <div class="layui-tab layui-tab-brief" lay-filter="tab_demo">
            <ul class="layui-tab-title">
                <li lay-id="1" class="layui-this">图片上传</li>
                <li lay-id="2">音频上传</li>
                <li lay-id="3">视频上传</li>
                <li lay-id="4">PDF上传</li>
            </ul>
            <div class="layui-tab-content " style="height: 100px;">
                ...
                <div class="layui-tab-item layui-show layui-row">
                    <div class="layui-upload">
                        ...
                        <button type="button" class="layui-btn" id="img_up">上传</button>
                        <div class="layui-upload-list" style="margin-left: 7rem">
                            ...
                            <input type="hidden" class="url" name="img_url" value="<?php echo (isset($info['url']) && ($info['url'] !== '')?$info['url']:''); ?>">
                            <p id="demoText"></p>
                        </div>
                    </div>
                    <div class="layui-form-item">
                ...
                <div class="layui-tab-item">
                    <div class="layui-form-item">
                        <div class="layui-upload">
                            ...
                            <input type="hidden" name="pdf_url" value="<?php echo (isset($info['url']) && ($info['url'] !== '')?$info['url']:''); ?>">
                        </div>
                    </div>
                </div>
...
<script>
    layui.use(['form', 'element','upload'], function(){
        ...
        //切换选项卡
        element.on('tab(tab_demo)', function(data){
            ...
            $('input[name="file_format"]').val('');
        });

        //Hash地址的定位
        var layid = location.hash.replace(/^#tab=/, '');
        element.tabChange('tab_demo', layid);
        ...
        upload.render({
            ...
            ,done: function(res){
                ...
                layer.msg(res.msg, {icon: 6,time: 1000});
                $('input[name="pdf_url"]').val(data.src);
