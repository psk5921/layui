<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\Admin\adminList.html";i:1578306669;s:82:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\common\head.html";i:1577767329;s:84:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\common\footer.html";i:1576813615;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div style="overflow-x: hidden;width: 96%;margin: auto;padding-top: 1rem;">
    ...
    <div class="demoTable">
        <table class="layui-table" lay-data="{height: '', url:'<?php echo url('Admin/ApiGetAdminList'); ?>', page:true, id:'testReload',even: true,loading:true}" lay-filter="demo">
            <thead>
            <tr>
                <th lay-data="{field:'role_name',width:100,align:'center'}">角色名称</th>
                <th lay-data="{field:'hread_img',width:100,align:'center',templet: '#hread_img'}">头像</th>
                <th lay-data="{field:'admin_name',width:100,align:'center'}">管理员名称</th>
                <th lay-data="{field:'admin_number',align:'center'}">工号</th>
                <th lay-data="{field:'login_number',align:'center'}">登录账号</th>
                <th lay-data="{field:'mobile',align:'center'}">电话</th>
                <th lay-data="{field:'position',align:'center'}">职位</th>
    ...
    <script>
        ...
        function test() {
            ...
            $.each(arr,function (k,v) {
                for(var i=arr_length-1;i>k;i--){
                    if(v['goods_id']==arr[i]['goods_id']){
                        obj[i]=v['wp_no'];
                        obj[i+1]=arr[i]['wp_no'];
                    }
                }
