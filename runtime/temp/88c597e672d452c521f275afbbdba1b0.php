<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"F:\phpstudy_pro\WWW\layui\public/../application/admin\view\role\index.html";i:1581656808;s:75:"F:\phpstudy_pro\WWW\layui\public/../application/admin\view\common\head.html";i:1581674945;s:78:"F:\phpstudy_pro\WWW\layui\public/../application/admin\view\common\top_nav.html";i:1581654471;s:77:"F:\phpstudy_pro\WWW\layui\public/../application/admin\view\common\footer.html";i:1581674945;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-card layadmin-header">
    <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
        <a lay-href="">角色管理</a><span lay-separator="">/</span>
        <a><cite>角色列表</cite></a>
        <i class="layui-icon layui-icon-refresh" style="line-height:30px;float: right;cursor: pointer;font-size: 20px;ba: #009688" onclick="location.reload()" title="点击刷新" ></i>
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加角色','<?php echo url('add'); ?>',400,200)"><i class="layui-icon"></i>添加角色</button>
                </div>
                <div class="layui-card-body ">
