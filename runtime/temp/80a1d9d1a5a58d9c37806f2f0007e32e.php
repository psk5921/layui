<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\Log\order_price.html";i:1577773026;s:82:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\common\head.html";i:1577767329;s:84:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\common\footer.html";i:1576813615;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div style="overflow-x: hidden;width: 96%;margin: auto;padding-top: 1rem;">
    <blockquote class="layui-elem-quote layui-text">
        <div class="demoTable layui-form">
            <div class="layui-input-inline">
                <input type="text" name="RangeDate" class="layui-input RangeDate" placeholder=" 年月日-年月日 ">
            </div>
            <div class="layui-input-inline" style="width: 30%">
                <input type="text" name="order_number" placeholder="搜索订单编号" class="layui-input">
            </div>
    ...
    <div class="demoTable">
        <table class="layui-table" lay-data="{height: '', url:'<?php echo url('Log/apiGetOrderPriceLog'); ?>', page:true, id:'testReload',even: true,loading:true}" lay-filter="demo">
            <thead>
            <tr>
                <th lay-data="{field:'order_number',align:'center'}">订单编号</th>
                <th lay-data="{field:'order_price',align:'center',templet: '#hread_img'}">订单原价</th>
                <th lay-data="{field:'update_price',align:'center'}">修改后价格</th>
                <th lay-data="{field:'price_note',align:'center'}">修改备注</th>
                <th lay-data="{field:'admin_name',align:'center'}">操作人</th>
                <th lay-data="{field:'create_time',align:'center'}">操作时间</th>
            </thead>
        </table>
    </div>
...
<script>
    ...
    <script>
        layui.use(['table','laydate'], function(){
            ...
            var $ = layui.$, active = {
                reload: function(){
                    var rangeDate = $('input[name="RangeDate"]').val();
