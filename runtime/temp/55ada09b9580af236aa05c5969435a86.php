<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\Route\route_type.html";i:1577771515;s:82:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\common\head.html";i:1577767329;s:84:"F:\phpstudy_pro\WWW\travel_order\public/../application/admin\view\common\footer.html";i:1576813615;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div style="overflow-x: hidden;width: 96%;margin: auto;padding-top: 1rem;" class="cbp-spmenu-push">
   <!-- <blockquote class="layui-elem-quote layui-text">
    ...
    <table class="layui-table" lay-data="{height: '', url:'<?php echo (isset($url) && ($url !== '')?$url:''); ?>', page:true, id:'testReload',even: true,loading:true}" lay-filter="demo">
        <thead>
        <tr>
            <th lay-data="{field:'name'}">路线名称</th>
            ...
            switch(event){
                case 'edit':
                    layer.open({
                        ...
                        maxmin: true, //开启最大化最小化按钮
                        area: ['100%', '100%'],
                        content: '<?php echo url("Route/route_type_edit"); ?>?id='+data.id,
                        end: function () {
                            table.reload('testReload');
                        },
                    });
